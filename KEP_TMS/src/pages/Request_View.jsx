        ...
        <div className="flex-grow-1">
          ...
          >
            <h3 className="fw-bold" style={{ color: "rgb(0,75,80)" }}>
              Training Requests || Add Request
            </h3>
            <p className="m-0">
              To add a new training request, fill out the form with the course
              name, desired date, and any special requirements. Click
              &apos;Submit to finalize your request.
            </p>
            <div className="d-flex mt-3">
              <a
                ...
                role="button"
                href="#"
                style={{ background: "#00a76f", borderColor: "#00a76f" }}
