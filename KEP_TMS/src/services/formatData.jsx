...
export const InsertFormattedTrainingRequestData = (formData)=>{
    ...
    return{
        ...
        trainingProviderId: formData.trainingProgramId,
        trainingTypeId: formData.trainingTypeId,
        trainingObjectives: formData.trainingObjectives,
        venue: formData.venue,
        trainingParticipants: formData.trainingParticipants? formData.trainingParticipants.map(({id})=>({
            employeeId: id
        })):[]
        ,
        isOffSite: true,
        ...
        trainingFacilitators:formData.trainingFacilitators ? formData.trainingFacilitators.map(({id}) =>({
            facilitorId: id
        })):[],
