...
const Sidebar = ({}) => {
  ...
  const getClassName = (page) =>
    `nav-link py-3 rounded-0 ${
      location.pathname === page ? "link-light active" : "text-secondary"
    }`;
  ...
  return (
    ...
    >
      ...
      >
        <Link
          className="text-center link-body-emphasis d-block text-decoration-none py-3"
          href="/"
          title=""
        ...
        >
          <img
            src="assets/img/14-removebg-preview%201.png"
            width="43"
            height="38"
          />
        </Link>
